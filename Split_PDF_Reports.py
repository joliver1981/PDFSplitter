...
# 2. targetPDFFile - Source file is copied to this temp file
# 3. outputPDFDir - Output directory for split files
# 4. outputNamePrefix - Prefix to append to file names
# 5. deleteSourcePDF - Delete source PDF file after split (True/False)
######################################################################
...
targetPDFFile = sys.argv[2]
outputPDFDir = sys.argv[3]
outputNamePrefix = sys.argv[4]
